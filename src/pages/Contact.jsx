...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    // Silent bot trap: If honeypot is filled, reject immediately
    ...
    try {
      const response = await fetch('https://formsubmit.co/ajax/tcetacm@thakureducation.org', {
        ...
        body: JSON.stringify({
          _subject: `[TCET ACM Inquiry] ${formData.category}: ${formData.subject}`,
          _template: 'table',
      ...
      // Construct mailto link as graceful fallback
      const mailtoUrl = `mailto:tcetacm@thakureducation.org?subject=${encodeURIComponent(`[${formData.category}] ${formData.subject}`)}&body=${encodeURIComponent(`From: ${formData.fullName} (${formData.email})\nDepartment: ${formData.department}\n\n${formData.message}`)}`;
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-1.5 text-left">
                  <label className="font-mono text-xs font-bold text-[#0B1F33] block">
                    Full Name *
                  </label>
                  <input
                    type="text"
              ...
              {/* Row 2: Department & Inquiry Category */}
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-1.5 text-left">
                  <label className="font-mono text-xs font-bold text-[#0B1F33] block">
                    Academic Department
              ...
              <div className="space-y-1.5 text-left">
                ...
                <textarea
                  ...
                  className="w-full px-4 py-2.5 rounded-xl bg-[#EFF6FF] border border-[#93C5FD] text-[#0B1F33] placeholder-[#3B82F6]/60 text-base sm:text-sm font-medium focus:outline-none focus:border-[#1D4ED8] transition-colors resize-y"
                />
              </div>
              ...
              <button
                ...
                className="w-full py-3.5 rounded-xl bg-[#FFD43B] text-[#0B1F33] font-mono text-xs font-bold uppercase tracking-wider hover:bg-[#FFC71F] active:scale-[0.99] transition-all duration-300 shadow-sm flex items-center justify-center gap-2 cursor-pointer disabled:opacity-50"
              >
