...
export const CONTACT_INFO_CARDS = [
  {
    ...
    badge: "Thakur Educational Campus",
    lines: [
      "Department of Information Technology, Room 405",
    ...
    highlight: "Kandivali East, Mumbai 400101"
  },
  {
    id: "inquiries",
  ...
  {
    id: "hours",
    title: "Active Chapter Hours",
    badge: "Academic Term Schedule",
    lines: [
      "Monday — Saturday: 08:30 AM – 05:30 PM IST",
      "Closed on National & Institutional Holidays"
    ],
    highlight: "Student Lab Hours: Mon – Fri (03:30 – 05:30 PM)"
  }
];
