...
export const clubEvents = [
  ...
  },
  {
    ...
    badgeTheme: { bg: "bg-[#06B6D4]", text: "text-white", border: "border-cyan-400/40" },
    hasReport: true,
  ...
  },
  {
    ...
    badge: "Social Cause",
    badgeTheme: { bg: "bg-[#10B981]", text: "text-white", border: "border-emerald-400/40" },
    hasReport: true,
  ...
  },
  {
    ...
    badge: "Ideathon",
    badgeTheme: { bg: "bg-[#8B5CF6]", text: "text-white", border: "border-purple-400/40" },
    hasReport: false,
  ...
  },
  {
    ...
    badge: "Summit",
    badgeTheme: { bg: "bg-[#F43F5E]", text: "text-white", border: "border-rose-400/40" },
    hasReport: false,
  ...
  },
  {
    ...
    badge: "Fest",
    badgeTheme: { bg: "bg-[#EC4899]", text: "text-white", border: "border-pink-400/40" },
    hasReport: false,
