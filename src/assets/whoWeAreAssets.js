...
export const branchCounsellor = {
  ...
  impacts: [
    ...
    "Established 4 Specialization Research Labs",
    "Spearheaded national-level hackathons and patent filings"
  ],
  github: null,
  linkedin: null,
...
export const facultyMentorsList = [
  {
    ...
    impacts: [
      ...
      "Lead Organizer for ACM Pre-Conference Workshops",
      "Guided 100% placement track records for core officers"
    ],
    github: null,
    linkedin: null,
  ...
  },
  {
    ...
    impacts: [
      ...
      "Curates Competitive Programming Masterclasses",
      "Coordinates industry mentorship talk series"
    ],
    github: null,
    linkedin: null,
  ...
  },
  {
    ...
    impacts: [
      ...
      "Coordinates NGO digital literacy programs",
      "Oversees annual chapter gala & awards"
    ],
    github: null,
    linkedin: null,
...
export const studentPerspectivesList = [
  {
    id: "girik-shukla",
    name: "Girik Shukla",
    role: "Chairperson",
    ...
    impacts: [
      "Directed chapter operations & national hackathons",
      "Expanded student community engagement",
      "Oversees technical masterclasses and mentorship"
    ],
  ...
  },
  {
    ...
    impacts: [
      "Co-managed 15+ chapter events & workshops",
  ...
  },
  {
    ...
    impacts: [
      ...
      "Streamlined chapter administrative workflows",
      "Authored annual activity portfolios"
    ],
  ...
  },
  {
    ...
    impacts: [
      "Managed 12+ flagship events & hackathons",
  ...
  },
  {
    ...
    impacts: [
      "Managed hackathon prize allocations",
  ...
  },
  {
    ...
    impacts: [
      ...
      "Maintained 99.9% uptime for hackathon platforms",
      "Implemented responsive spatial UI designs"
    ],
