          ...
          <div className="max-w-md w-full p-8 rounded-3xl bg-white border-2 border-[#BFDBFE] shadow-xl space-y-6">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-2">
              <button
                ...
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-full bg-[#1D4ED8] text-white font-mono text-sm font-bold uppercase tracking-wider shadow-md hover:bg-[#1E40AF] transition-all cursor-pointer"
              >
              ...
              <button
                ...
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-full bg-slate-100 text-slate-700 font-mono text-sm font-bold uppercase tracking-wider hover:bg-slate-200 transition-all cursor-pointer"
              >
